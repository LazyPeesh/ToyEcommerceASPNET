...
namespace ToyEcommerceASPNET.Controllers
{
	...
	public class TransactionController : ControllerBase
	{
		...
		//// PUT api/v1/transactions/{id}
		//[HttpPut("/ChangeTransactionStatus/{id}")]
		//[Authorize("IsAdmin")]
		//public async Task<IActionResult> ChangeTransactionStatus([FromRoute] int id, string status)
		//{
		//	try
		//	{
		//		var currentTransaction = await _transactionService.GetTransactionById(id);
