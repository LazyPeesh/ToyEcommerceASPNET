...
namespace ToyEcommerceASPNET.Controllers
{
	...
	public class CartController : ControllerBase
	{
		...
		public CartController(ICartService cartService, IProductService productServices, IMapper mapper)
		{
		...
		public async Task<IActionResult> AddToCart([FromBody] JsonObject request)
		{
			try
			{
				...
				else
				{
					...
					var addedProduct = _productServices.GetProductById(productId);
